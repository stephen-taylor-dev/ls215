...
2. Find the queen's locations within the board
  - Use queenCoordinates, passing in our board, and get back our object
   with coordinates
...
function queenAttack(board) {
  ...
  let coordinates = queenCoordinates(boardArray);
  ...
  return attackableCoordiantes(coordinates['W'], coordinates['B']);
}
...
function attackableCoordiantes(coordinate1, coordinate2) {
  if (coordinate1[0] === coordinate2[0]) {
    return true;
  } else if (coordinate1[1] === coordinate2[1]) {
    return true;
  } else if (diagonalCoordinates(coordinate1, coordinate2)) {
    return true;
  }
  return false;
}

function diagonalCoordinates(coordinate1, coordinate2) {
  let rowDiff = Math.abs(coordinate1[0] - coordinate2[0]);
  let colDiff = Math.abs(coordinate1[1] - coordinate2[1]);
